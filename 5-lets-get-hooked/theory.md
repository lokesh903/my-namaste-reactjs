...
```
## Q: if state variables update that component having that variable initalized also rerenders but dose its parent component also rerenders?

1. no it does not rerenders the parent component.
2. but if parent component is initializing the state variable and it passes setState to child and there we call setState to alter the state variable then parent component will rerenders.
