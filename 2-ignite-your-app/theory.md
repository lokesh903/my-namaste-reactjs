...
A: `package.json`:
* it has approx versions of deps using tilde or corect sign
...
* It records the same version which is used in node_modules and it also have the data for dependencies of dependencies `transitive dependency`
